...
/**
 * Displays list of books, stored in the database.
 */
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        // and Zafon's book attributes are the values.
        ContentValues values = new ContentValues();
        values.put(BookEntry.COLUMN_BOOK_NAME, "La sombra del viento");
        values.put(BookEntry.COLUMN_BOOK_AUTHOR, "Carlos Ruiz Zafón");
        values.put(BookEntry.COLUMN_BOOK_PRICE, 12);
        values.put(BookEntry.COLUMN_BOOK_STOCK, 7);
        values.put(BookEntry.COLUMN_BOOK_SUPPL_NAME, "The Big Bookshop");
        values.put(BookEntry.COLUMN_BOOK_SUPPL_PHONE, "0932999999");

        // Insert a new row for Zafon into the provider using the ContentResolver.
